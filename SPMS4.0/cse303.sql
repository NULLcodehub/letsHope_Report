...
(1930188, 'Sourav', 'Saha', '1998-28-10', 'male', '1930188@iub.edu.bd', '123446', 'R-49', 'CSE', 9, '12345', 'spring', '2021'),
(1920137, 'Bonni', 'Basak', '2001-03-10', 'female', '1920137@iub.edu.bd', '1234654', 'R-23', 'CSE', 14, '12345', 'summer', '2021'),
...
INSERT INTO student_t(`studentID`, `firstName`, `lastName`, `dateOfBirth`, `gender`, `email`, `phone`, `address`, `departmentID`, `programID`, `password`, `enrollmentSemester`, `enrollmentYear`) VALUES
(1931161, 'Syeda Abidan', 'Sultan', '2014-11-05', 'female', 'ahspdnsgsj', '12296', 'R-231', 'ENG', 13, '', 'autumn', '2021');
-- --------------------------------------------------------


CREATE TABLE student_performance_outcome (
  ...
  total_mark INT,
  grade VARCHAR(2),
  CONSTRAINT PK_student_performance PRIMARY KEY (student_id, course_id, year, semester)
);


-- inserting data to student_performance_outcome table

INSERT INTO student_performance_outcome
(student_id, course_id, section_id, year, semester, mid_mark, final_mark, mco1, mco2, mco3, fco1, fco2, fco3, total_mark, grade)
VALUES
(1930182, 'cse303', 1, 2022, 'Fall', 70, 80, 20, 25, 25, 20, 20, 15, 150, 'A'),
(1930189, 'cse303L', 1, 2022, 'Fall', 75, 90, 20, 25, 30, 25, 20, 15, 165, 'A+'),
(1930178, 'cse204', 4, 2021, 'Spring', 80, 85, 25, 25, 30, 20, 20, 15, 165, 'A+'),
(1930180, 'cse204L', 4, 2021, 'Spring', 65, 75, 15, 20, 20, 20, 15, 10, 140, 'B'),
(1920138, 'cse303', 1, 2023, 'Fall', 85, 90, 25, 30, 30, 25, 20, 15, 185, 'A+'),
(1920139, 'cse303L', 1, 2023, 'Fall', 70, 80, 20, 25, 25, 20, 20, 15, 150, 'A'),
(1930181, 'cse316', 1, 2023, 'Spring', 75, 80, 20, 25, 25, 20, 20, 15, 155, 'A'),
(1930111, 'cse316L', 1, 2023, 'Spring', 90, 95, 30, 30, 30, 25, 20, 20, 185, 'A+'),
(1920199, 'cse216', 4, 2023, 'Fall', 70, 80, 20, 25, 25, 20, 20, 15, 150, 'A'),
(1920167, 'cse216L', 4, 2023, 'Fall', 85, 90, 25, 30, 30, 25, 20, 15, 185, 'A+'),
(1930134, 'cse213', 1, 2022, 'Spring', 75, 85, 20, 25, 30, 20, 20, 15, 160, 'A+'),
(1920122, 'mat201', 1, 2022, 'Spring', 65, 75, 15, 20, 20, 20, 15, 10, 140, 'B'),
(1930156, 'mat201', 1, 2020, 'Fall', 90, 95, 30, 30, 30, 25, 20, 20, 185, 'A+');




-- student performance backlog data--


CREATE TABLE student_Data_backlog(
  ...
  CONSTRAINT PK_student_data PRIMARY KEY (studentID, semester,courseID, year),
  FOREIGN KEY (studentID) REFERENCES student_t(studentID),
  FOREIGN KEY (courseID) REFERENCES course_t(courseID),
  FOREIGN KEY (facultyID) REFERENCES faculty_t(f_employeeID)
